...
<html>
	...
	<body>
		...
		<div class="row" style="width:1250px;margin:0 auto;padding-bottom: 20px;]">
			<div class="col-md-12">
				<ol class="breadcrumb">
					<li><a href="#">首页</a></li>
				</ol>
			...
			<c:forEach items="${ page.list}" var="p">
				<div class="col-md-2" style="padding-top: 20px">
					...
					<p><a href="${pageContext.request.contextPath}/ProductServlet?method=productInfo&pid=${p.pid }" style='color:green'>${p.pname }</a></p>
		...
		<div class="row" style="width:1250px;margin:0 auto;padding-bottom: 20px;]">
			<div class="col-md-12">
				<ol class="breadcrumb">
					<li><h3><strong>暂无该类商品信息,尽请期待！</strong></h3></li>
				</ol>
			</div>
		</div>
		</c:if>		
